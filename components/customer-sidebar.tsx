...
const links = [
  { href: "/customer/catalog", label: "Catalog" },
  ...
  return (
    <aside className="flex w-full flex-col border-b border-slate-200 bg-slate-50 md:h-screen md:w-56 md:border-b-0 md:border-r">
      <div className="border-b border-slate-200 px-4 py-4">
        <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Store portal</p>
        <p className="text-sm font-semibold text-slate-900">Ordering</p>
      </div>
